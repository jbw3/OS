...
_OBJ = boot.o debug.o gdt.o idt.o interrupt.o irq.o isr.o keyboard.o main.o paging.o paging_asm.o screen.o shell.o stdlib.o stdio.o string.o system.o system_asm.o timer.o
